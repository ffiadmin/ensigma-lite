...
//Validation language
(function($){$.fn.validationEngineLanguage=function(){};$.validationEngineLanguage={newLang:function(){$.validationEngineLanguage.allRules={"required":{"regex":"none","alertText":"* This field is required","alertTextCheckboxMultiple":"* Please select an option","alertTextCheckboxe":"* This checkbox is required"},"minSize":{"regex":"none","alertText":"* Minimum ","alertText2":" characters allowed"},"maxSize":{"regex":"none","alertText":"* Maximum ","alertText2":" characters allowed"},"min":{"regex":"none","alertText":"* Minimum value is "},"max":{"regex":"none","alertText":"* Maximum value is "},"past":{"regex":"none","alertText":"* Date prior to "},"future":{"regex":"none","alertText":"* Date past "},"maxCheckbox":{"regex":"none","alertText":"* Maximum ","alertText2":" options allowed"},"minCheckbox":{"regex":"none","alertText":"* Please select ","alertText2":" options"},"equals":{"regex":"none","alertText":"* Fields do not match"},"phone":{"regex":/^([\+][0-9]{1,3}[\.\-])?([\(]{1}[0-9]{2,6}[\)])?([0-9\.\-\/]{3,20})((x|ext|extension)[]?[0-9]{1,4})?$/,"alertText":"* Invalid phone number"},"email":{"regex":/^((([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+(\.([a-z]|\d|[!#\$%&'\*\+\-\/=\?\^_`{\|}~]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])+)*)|((\x22)((((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(([\x01-\x08\x0b\x0c\x0e-\x1f\x7f]|\x21|[\x23-\x5b]|[\x5d-\x7e]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(\\([\x01-\x09\x0b\x0c\x0d-\x7f]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]))))*(((\x20|\x09)*(\x0d\x0a))?(\x20|\x09)+)?(\x22)))@((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?$/i,"alertText":"* Invalid email address"},"integer":{"regex":/^[\-\+]?\d+$/,"alertText":"* Not a valid integer"},"number":{"regex":/^[\-\+]?(([0-9]+)([\.,]([0-9]+))?|([\.,]([0-9]+))?)$/,"alertText":"* Invalid floating decimal number"},"date":{"regex":/^\d{4}[\/\-](0?[1-9]|1[012])[\/\-](0?[1-9]|[12][0-9]|3[01])$/,"alertText":"* Invalid date, must be in YYYY-MM-DD format"},"ipv4":{"regex":/^((([01]?[0-9]{1,2})|(2[0-4][0-9])|(25[0-5]))[.]){3}(([0-1]?[0-9]{1,2})|(2[0-4][0-9])|(25[0-5]))$/,"alertText":"* Invalid IP address"},"url":{"regex":/^(https?|ftp):\/\/(((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:)*@)?(((\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5])\.(\d|[1-9]\d|1\d\d|2[0-4]\d|25[0-5]))|((([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|\d|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.)+(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])*([a-z]|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])))\.?)(:\d*)?)(\/((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)+(\/(([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)*)*)?)?(\?((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|[\uE000-\uF8FF]|\/|\?)*)?(\#((([a-z]|\d|-|\.|_|~|[\u00A0-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF])|(%[\da-f]{2})|[!\$&'\(\)\*\+,;=]|:|@)|\/|\?)*)?$/i,"alertText":"* Invalid URL"},"onlyNumberSp":{"regex":/^[0-9\ ]+$/,"alertText":"* Numbers only"},"onlyLetterSp":{"regex":/^[a-zA-Z\ \']+$/,"alertText":"* Letters only"},"onlyLetterNumber":{"regex":/^[0-9a-zA-Z]+$/,"alertText":"* No special characters allowed"},"ajaxUserCall":{"url":"ajaxValidateFieldUser","extraData":"name=eric","alertText":"* This user is already taken","alertTextLoad":"* Validating, please wait"},"ajaxUserCallPhp":{"url":"phpajax/ajaxValidateFieldUser.php","extraData":"name=eric","alertTextOk":"* This username is available","alertText":"* This user is already taken","alertTextLoad":"* Validating, please wait"},"ajaxNameCall":{"url":"ajaxValidateFieldName","alertText":"* This name is already taken","alertTextOk":"* This name is available","alertTextLoad":"* Validating, please wait"},"ajaxNameCallPhp":{"url":"phpajax/ajaxValidateFieldName.php","alertText":"* This name is already taken","alertTextLoad":"* Validating, please wait"},"validate2fields":{"alertText":"* Please input HELLO"},"noSpecialCharacters":{"regex":"/^[0-9a-zA-Z ]+$/","alertText":"* No special characters allowed"},"noSpecialCharactersSpaces":{"regex":"/^[0-9a-zA-Z]+$/","alertText":"* No special characters allowed"},"ajaxUser":{"file":document.location.href+"?validate=true","extraData":"name=eric","alertTextOk":"* This user is available","alertTextLoad":"* Loading, please wait","alertText":"* This user is already taken"},"ajaxName":{"file":document.location.href,"alertText":"* Incorrect answer","alertTextOk":"* Correct answer","alertTextLoad":"* Loading, please wait"},"bannerUpload":{"nname":"bannerUpload","alertText":"* Invalid file type"},"iconUpload":{"nname":"iconUpload","alertText":"* Invalid file type"},"onlyLetter":{"regex":"/^[a-zA-Z\ \']+$/","alertText":"* Letters only"},"validate2fields":{"nname":"validate2fields","alertText":"You must have a firstname and a lastname"}}}};$.validationEngineLanguage.newLang()})(jQuery);

//JavaScript extension
function errorsOnSubmit(form,upload,forced,extension){var jqueryValidate=$('#'+form.id).validationEngine({returnIsValid:true});if(jqueryValidate==true){if(upload==false||!upload){return successDisplay('1','0','0','1')}else{return uploadCheck(upload,forced,extension,'true')}}if(jqueryValidate==false){return errorDisplay('1','1','0','1');return uploadCheck(upload,forced,extension,'false')}}function uploadCheck(uploadInput,forcedInput,extensionInput,returnTrue){if(uploadInput!=""||uploadInput!=false){var uploadSplit=uploadInput.split(".");var i;var result="1";var extensionCheck="0";for(i in uploadSplit){var fileCheck=document.getElementById(uploadSplit[i]).value;if(fileCheck==""||fileCheck==false){var result="0"}else{if(extensionInput!=undefined){var extensionSplit=extensionInput.split(".");var n;for(n in extensionSplit){var lowerCase=fileCheck.toLowerCase();if(lowerCase.match(extensionSplit[n])){var extensionCheck="1"}}}else{var extensionCheck="1"}}}if(result=="0"){if(forcedInput=="true"){return errorDisplay('1','1','0','1')}else{return successDisplay('1','0','1','1')}}else{if(extensionCheck=="1"){if(returnTrue=="true"){return successDisplay('1','1','1','1')}else{return successDisplay('1','1','1','0')}}if(extensionCheck=="0"){return errorDisplay('1','1','1','1')}}}else{if(returnTrue=="true"){return successDisplay('1','1','1','1')}else{return successDisplay('1','1','1','0')}}}function errorDisplay(errorShow,progressClear,errorWinShow,errorReturn){var errorWindow=document.getElementById('errorWindow');var progressBox=document.getElementById('progress');var errorBox=document.getElementById('errorBox');if(errorShow=="1"){errorBox.style.display='block';errorBox.style.border='1px solid #CC3333';errorBox.style.color='#CC3333';errorBox.style.width='405px'}if(progressClear=="1"){progressBox.style.display='none'}if(errorWinShow=="1"){if(errorWindow){errorWindow.style.display='block'}}if(errorReturn=="1"){return false}}function successDisplay(errorClear,progressShow,errorWinClear,errorClearReturn){var errorWindow=document.getElementById('errorWindow');var progressBox=document.getElementById('progress');var errorBox=document.getElementById('errorBox');if(errorClear=="1"){errorBox.style.display='none'}if(progressShow=="1"){progressBox.style.display='block'}if(errorWinClear=="1"){if(errorWindow){errorWindow.style.display='none'}}if(errorClearReturn=="1"){return true}}function bannerUpload(){var formName=document.getElementById('validate');var extensionInput="png,bmp,jpg,gif";var extensionSplit=extensionInput.split(",");var possibleExtensions=extensionSplit.length-1;var returnType=false;for(var count=0;count<=formName.elements.length;count++){var type=formName.elements[count].type;if(type==="file"){var fileCheck=formName.elements[count].value;if(fileCheck!==""){var extensionPrep=fileCheck.split(".");var extension=extensionPrep[extensionPrep.length-1].toLowerCase();for(var i in extensionSplit){if(extension===extensionSplit[i]){return true;break}else{if(i==possibleExtensions){return false}}}}else{return false}}}}function iconUpload(){var formName=document.getElementById('validate');var extensionInput="png,ico,jpg,gif";var extensionSplit=extensionInput.split(",");var possibleExtensions=extensionSplit.length-1;var returnType=false;for(var count=0;count<=formName.elements.length;count++){var type=formName.elements[count].type;if(type==="file"){var fileCheck=formName.elements[count].value;if(fileCheck!==""){var extensionPrep=fileCheck.split(".");var extension=extensionPrep[extensionPrep.length-1].toLowerCase();for(var i in extensionSplit){if(extension===extensionSplit[i]){return true;break}else{if(i==possibleExtensions){return false}}}}else{return false}}}}