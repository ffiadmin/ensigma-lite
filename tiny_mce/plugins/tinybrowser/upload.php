...
<?php
//Display the max upload sizes
	echo "<br />Max file size (for single file): " . ini_get('upload_max_filesize');
	echo "<br />Max file size (for all files): " . ini_get('post_max_size');
?>
</fieldset></div></div>
</body>
</html>
