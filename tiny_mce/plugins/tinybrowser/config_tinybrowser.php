...
$tinybrowser['maxsize']['image'] = trim(ini_get('upload_max_filesize'), "M")*1024*1024; // Image file maximum size
$tinybrowser['maxsize']['media'] = trim(ini_get('upload_max_filesize'), "M")*1024*1024; // Media file maximum size
$tinybrowser['maxsize']['file']  = trim(ini_get('upload_max_filesize'), "M")*1024*1024; // Other file maximum size
